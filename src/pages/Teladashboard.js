...
import Telacriacaocateg from './Telacriacaocateg'; // <-- 1. ADICIONADO
...
const Teladashboard = () => {
 ...
 const handleNewTransaction = (type) => {
  ...
  // <-- 2. ADICIONADO (Função para abrir modal de categoria) -->
  ...
  <div className="page-layout">
   <Sidebar
    ...
    onNewTransaction={handleNewTransaction}
        onNewCategory={handleNewCategory} // <-- 3. ADICIONADO (Prop passada para Sidebar)
   />
   ...
   <div className="main-content-area">
    ...
    {modalType === 'receita' && (
     ...
     />
        ...
        {/* <-- 4. ADICIONADO (Renderização do modal de categoria) --> */}
    {modalType === 'categoria' && (
     <Telacriacaocateg
      onClose={handleCloseModal}
      onSaveSuccess={() => {
